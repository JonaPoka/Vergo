...
public abstract class World implements IBlockAccess
{
    ...
    public Vec3 getSkyColor(Entity entityIn, float partialTicks)
    {
        ...
        EventGetSkyAndFogColor event = new EventGetSkyAndFogColor(new Vec3((double)f3, (double)f4, (double)f5));
    ...
    public Vec3 getFogColor(float partialTicks)
    {
        ...
        EventGetSkyAndFogColor event = new EventGetSkyAndFogColor(this.provider.getFogColor(f, partialTicks));
        event.setType(EventType.PRE);
        event.fire();
    ...
    public <T extends Entity> List<T> getEntities(Class <? extends T > entityType, Predicate <? super T > filter)
    {
        ...
        for (Object entity : this.loadedEntityList)
        {
