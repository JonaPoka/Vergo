...
public class ItemPotion extends Item
{
    ...
    public static boolean isPotionBad(ItemStack fuckYou) {
    	List<PotionEffect> FUCKOFF = Items.potionitem.getEffects(fuckYou);
    	for (PotionEffect bitch : FUCKOFF) {
    		Potion potion = Potion.potionTypes[bitch.getPotionID()];
    ...
    public static List<PotionEffect> getPotionEffects(ItemStack fuckYou) {
    	return Items.potionitem.getEffects(fuckYou);
    }
