        ...
        else
        {
            ...
            if (flag)
            {
            	...
            	if (sneak.isCanceled()) {
	                ...
	                for (d6 = 0.05D; x != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(x, sneak.offset, 0.0D).expand(sneak.hitboxExpand, sneak.hitboxExpand, sneak.hitboxExpand)).isEmpty(); d3 = x)
	                {
	                    if (x < d6 && x >= -d6)
	                    {
	                        x = 0.0D;
	                ...
	                for (; z != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(0.0D, sneak.offset, z).expand(sneak.hitboxExpand, sneak.hitboxExpand, sneak.hitboxExpand)).isEmpty(); d5 = z)
	                {
	                    if (z < d6 && z >= -d6)
	                    {
	                        z = 0.0D;
	                ...
	                for (; x != 0.0D && z != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(x, sneak.offset, z).expand(sneak.hitboxExpand, sneak.hitboxExpand, sneak.hitboxExpand)).isEmpty(); d5 = z)
	                {
	                    if (x < d6 && x >= -d6)
	                    {
	                        x = 0.0D;
