...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
    	...
    	if (Vergo.config.modSmallItems.isEnabled())
    		GlStateManager.translate(0.75 * ((100 - Vergo.config.modSmallItems.scale.getValueAsDouble()) / 100), -0.15 * ((100 - Vergo.config.modSmallItems.scale.getValueAsDouble()) / 100), -1 * ((100 - Vergo.config.modSmallItems.scale.getValueAsDouble()) / 100));
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
    					...
    					if (!Vergo.config.modAnimations.isEnabled()) {
    						this.transformFirstPersonItem(f, 0.0f);
    						this.func_178103_d();
    					}else {
