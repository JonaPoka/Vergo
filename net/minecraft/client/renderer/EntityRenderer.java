    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            else
            {
                ...
                if (Vergo.config.modReach.isEnabled())
                	d0 = Vergo.config.modReach.combatReach.getValueAsDouble();
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (Vergo.config.modReach.isDisabled() ? 3.0D : Vergo.config.modReach.combatReach.getValueAsDouble() + 0.1))
            {
                this.pointedEntity = null;
