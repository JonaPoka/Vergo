    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                if (RenderUtils.shouldSetCustomPitch && entity == Minecraft.getMinecraft().thePlayer) {
                	f8 = RenderUtils.getCustomPitch();
                }
                
                if (RenderUtils.shouldSetCustomYaw && entity == Minecraft.getMinecraft().thePlayer) {
                ...
                else
                {
                    ...
                    if (Vergo.config.modPlayerESP.isEnabled()) {
                        ...
                        if (entity instanceof EntityPlayer && (Vergo.config.modAntibot.isDisabled() || !AntiBot.isBot(((EntityPlayer) entity)))) {
